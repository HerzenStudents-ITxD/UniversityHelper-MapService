...
public class EditPointAssociationRequestValidator : AbstractValidator<EditPointAssociationRequest>, IEditPointAssociationRequestValidator
{
  public EditPointAssociationRequestValidator()
  {
  ...
  public async Task<ValidationResult> ValidateAsync(EditPointAssociationRequest request)
  {
