...
using UniversityHelper.MapService.Models.Dto.Configurations;
...
public class Startup : BaseApiInfo
{
  ...
  public Startup(IConfiguration configuration)
  {
    ...
    Version = "2.0.2.0";
    Description = "MapService is an API intended to work with the map.";
  ...
  public void ConfigureServices(IServiceCollection services)
  {
    ...
    services.AddDbContext<MapServiceDbContext>(options =>
    {
  ...
  {
    app.UpdateDatabase<MapServiceDbContext>();
